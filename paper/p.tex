...
excerpts from a broad range of genres). To this end, we include audio feature
extractions that represent the time-frequency information of each stimulus in
