...
code for the implementation of the stimulation paradigm are included in the
data release.  Additional scripts for data conversion and quality control are
